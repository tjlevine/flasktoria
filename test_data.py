...
def driver_name(vehicle_id):
    drivers = {
        'VEHICLE-0': 'Lewis Hamilton',
        'VEHICLE-1': 'Daniel Ricciardo',
        'VEHICLE-2': 'Nico Rosberg',
        'VEHICLE-3': 'Sebastian Vettel',
        'VEHICLE-4': 'Max Verstappen',
        'VEHICLE-5': 'Kimi Räikkönen',
        'VEHICLE-6': 'Sergio Perez',
        'VEHICLE-7': 'Valtteri Bottas',
        'VEHICLE-8': 'Nico Hulkenberg',
        'VEHICLE-9': 'Fernando Alonso',
        'VEHICLE-10': 'Felipe Massa',
        'VEHICLE-11': 'Carlos Sainz',
        'VEHICLE-12': 'Romain Grosjean',
        'VEHICLE-13': 'Daniil Kvyat',
        'VEHICLE-14': 'Kevin Magbussen',
        'VEHICLE-15': 'Jolyon Palmer',
        'VEHICLE-16': 'Pascal Wehrlein',
        'VEHICLE-17': 'Stoffel Vandoorne',
        'VEHICLE-18': 'Marcus Ericsson',
        'VEHICLE-19': 'Esteban Ocon',
        'VEHICLE-20': 'Lance Stroll',
